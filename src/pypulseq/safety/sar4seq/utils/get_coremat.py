...
def get_coremat(Qinds: np.ndarray, ind: np.ndarray, mu_per: float = 0.01):
    ...
    mu_per : relative threshold for spectral norm defining cluster end.
    ...
    mu_def : float absolute threshold used for clustering.
    """
    ...
    return Bstar, ind_sort, vop_ind, mu_def
